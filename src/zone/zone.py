...
from src.zone.consts import PROG, ZONE, NAME, CLOCK_ENABLED, GPIO_ECO, GPIO_FROSTFREE, CLASSNAME
...
class Zone:
    def __init__(self, number: int, network=None):
        ...
        self.clock_activated = config[CLOCK_ENABLED]
        ...
        if self.clock_activated and len(self.list_horaires) is not 0:
